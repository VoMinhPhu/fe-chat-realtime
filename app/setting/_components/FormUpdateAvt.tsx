...
const FormUpdateAvt = () => {
  ...
  return (
    <div className="p-4 flex flex-col items-center md:flex-row gap-4">
      <Sheet>
        ...
        <SheetContent side="top" className="w-full sm:w-[540px] mx-auto my-12">
          <SheetHeader>
            ...
            <SheetDescription>Make changes to your avatar here. Click save when you&apos;re done.</SheetDescription>
          </SheetHeader>
                    ...
                    >
                      <Avatar className="w-44 h-44 p-1 relative">
                        <AvatarImage
                          src={
                            previewImage ||
                            (currUser.avatar === null ? '/avt.svg' : `data:image/jpg;base64,${currUser.avatar}`)
                          }
                          alt="avt"
                          className="rounded-full"
                        />
                      ...
                      <div className="flex w-full justify-start">
                        <div className="mt-2 cursor-pointer border px-4 py-3 w-24 text-center rounded-md bg-primary text-primary-foreground">
                          Upload
                        </div>
                      </div>
                    </FormLabel>
                      ...
                      <div className="w-full flex justify-between">
                        ...
                        <div>
                          <FormLabel
                            ...
                            className="cursor-pointer w-full flex flex-col items-center justify-center"
                          >
                            <div className="border border-input px-4 py-3 rounded-md bg-background hover:bg-accent hover:text-accent-foreground">
                              Upload
                            </div>
                          </FormLabel>
                        </div>
      ...
      <div className="p-4">
        ...
        <p className="text-[#007aff] text-sm hidden md:block">{currUser.username}</p>
      </div>
    </div>
  );
};
